...
export const StatusBadge = ({ status }) => {
  ...
  const config = {
    submitted: { label: 'Submitted / Under Review', class: 'badge-submitted', icon: Clock },
    ...
    planning: { label: 'Planning', class: 'badge-assigned', icon: PlayCircle },
    prototype: { label: 'Prototype', class: 'badge-assigned', icon: PlayCircle },
    pilot: { label: 'Field Pilot', class: 'badge-assigned', icon: PlayCircle },
    ...
    selected: { label: 'Selected Solution', class: 'badge-selected', icon: Award },
    approved: { label: 'Approved', class: 'badge-resolved', icon: CheckCircle2 },
    pending: { label: 'Pending', class: 'badge-submitted', icon: Clock },
